...
argocd app create djangoargo --repo $APPLICATION_REPO --path deploymentchart --dest-server https://kubernetes.default.svc --dest-namespace default --revision $APPLICATION_TARGET_REVISION --sync-policy automated --dry-run
